...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # 중지 손가락 랜드마크 인덱스
            MIDDLE_FINGER_TIP = 12  # 중지 끝 랜드마크
            MIDDLE_FINGER_PIP = 10  # 중지 관절 랜드마크

            # 약지 손가락 랜드마크 인덱스
            RING_FINGER_TIP = 16  # 약지 끝 랜드마크
            RING_FINGER_PIP = 14  # 약지 관절 랜드마크
            ...
            ring_finger_up = is_finger_up(landmarks, RING_FINGER_TIP, RING_FINGER_PIP)

            # 새끼손가락은 접혀 있는지 확인
            pinky_finger_down = not is_finger_up(landmarks, PINKY_FINGER_TIP, PINKY_FINGER_PIP)

            # 검지, 중지, 약지만 펴져 있고 새끼손가락이 접혀 있으면 인식
